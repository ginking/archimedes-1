...
# alerts (@williamjdwest, @invacio). Read from environment variables.
...
# The user ID of @users to follow.
TRUMP_USER_ID = "25073877"
ELONMUSK_USER_ID = "44196397"
WARRENBUFFETT_USER_ID = "1364930179"
YOURANONNEWS_USER_ID = "279390084"
WIKILEAKS_USER_ID = "16589206"
SEC_NEWS_USER_ID = "18481050"
SEC_ENFORCEMENT_USER_ID = "299661515"
RICHARDBRANSON_USER_ID = "8161232"
# Add Name/Handle_USER_ID = "ID" to add more.
...
class Twitter:
    ...
    def get_tweets(self, since_id):
        """Looks up metadata for all Trump/Other tweets since the specified ID."""
...
class TwitterListener(StreamListener):
    ...
    def handle_data(self, logs, data):
        ...
        # We're only interested in accounts listed below so skip the rest.
